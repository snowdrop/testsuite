...
import static org.jboss.snowdrop.springboot.common.utils.OpenShiftUtils.waitForApplication;
...
public class OpenShiftIT {
    ...
    public static void prepare() throws Exception {
        ...
        waitForApplication(nameServiceUrl);
        waitForApplication(greetingServiceUrl);
    }
